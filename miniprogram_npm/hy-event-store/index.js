...
__DEFINE__(1682844433052, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1682844433053,"./event-store":1682844433054}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1682844433053, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1682844433054, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1682844433053,"./utils":1682844433055}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1682844433055, function(require, module, exports) {
...
return __REQUIRE__(1682844433052);
})()
